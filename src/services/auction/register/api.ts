...
export async function uploadAuctionImage(
  ...
  const response = await fetch("/auction/image", {
    method: "POST",
    body: formData,
  });
...
export async function saveAuctionDraft(
  ...
  const response = await fetch("/auction/draft", {
    method: "POST",
    headers: {
...
export async function recommendAuctionCategory(
  ...
  const response = await fetch("/auction/category/recommend", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function recommendAuctionPrice(
  ...
  const response = await fetch("/auction/price/recommend", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
