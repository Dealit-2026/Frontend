...
export default function RegularPurchaseScreen({ 
  productId,
  onBack, 
  onComplete, 
  themeColor,
        ...
        <div className="bg-white p-6 mb-2">
          ...
          <div className="flex space-x-4">
            <div className="w-20 h-20 bg-gray-100 rounded-xl overflow-hidden shrink-0">
              <img src={`https://picsum.photos/seed/${productId || 'product'}/200/200`} alt="Product" className="w-full h-full object-cover" />
            </div>
