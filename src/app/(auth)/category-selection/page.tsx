...
export function CategorySelectionScreen({ onBack, onComplete, onNavigateLogin, showSkip = false }: { onBack: () => void; onComplete: () => void; onNavigateLogin?: () => void; showSkip?: boolean; key?: string }) {
  const categories = [
    { name: "디지털기기", icon: "💻" },
    { name: "생활가전", icon: "📺" },
    { name: "가구/인테리어", icon: "🪑" },
